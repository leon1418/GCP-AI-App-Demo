...
GCP AI Dog Breed Detector — users upload dog photos, Gemini AI identifies breeds, results are displayed with query history. Showcases GCP services: Cloud Run, GCS, Firestore, Gemini, Firebase Auth.
...
- **Infra**: Terraform (terraform/), Docker + Cloud Run
...
- `app/main.py` — FastAPI routes, Firebase Auth middleware
...
- `terraform/` — Cloud Run, GCS, Firestore, Firebase, IAM infrastructure
